...
def clean(raw_data: pd.DataFrame) -> pd.DataFrame:
    ...
    out["survey_year"] = apply_lowest_int_dtype(
        float_categorical_to_int(raw_data["syear"]),
    )
    ...
    out["mini_job_prev_1"] = str_categorical(raw_data["kal1n001"], renaming={1: "Jan"})
    out["mini_job_prev_2"] = str_categorical(raw_data["kal1n002"], renaming={1: "Feb"})
    out["mini_job_prev_3"] = str_categorical(raw_data["kal1n003"], renaming={1: "Mär"})
    out["mini_job_prev_4"] = str_categorical(raw_data["kal1n004"], renaming={1: "Apr"})
    out["mini_job_prev_5"] = str_categorical(raw_data["kal1n005"], renaming={1: "Mai"})
    out["mini_job_prev_6"] = str_categorical(raw_data["kal1n006"], renaming={1: "Jun"})
    out["mini_job_prev_7"] = str_categorical(raw_data["kal1n007"], renaming={1: "Jul"})
    out["mini_job_prev_8"] = str_categorical(raw_data["kal1n008"], renaming={1: "Aug"})
    out["mini_job_prev_9"] = str_categorical(raw_data["kal1n009"], renaming={1: "Sep"})
    out["mini_job_prev_10"] = str_categorical(raw_data["kal1n010"], renaming={1: "Okt"})
    out["mini_job_prev_11"] = str_categorical(raw_data["kal1n011"], renaming={1: "Nov"})
    out["mini_job_prev_12"] = str_categorical(raw_data["kal1n012"], renaming={1: "Dez"})
    out["unempl_months_prev"] = int_categorical_to_int(raw_data["kal1d02"]).fillna(0)
